...
class Metric(models.Model):
    ...
    measurement = models.CharField(max_length=100, db_index=True)
    ...
    def __str__(self):
        return f"{self.measurement} - {self.timestamp}"
...
class Dashboard(models.Model):
    ...
    description = models.TextField(blank=True)
    config = models.JSONField(default=dict, help_text='Dashboard configuration including panels')
...
class DashboardPanel(models.Model):
    """Dashboard panel configurations for easier management"""
    ...
    panel_type = models.CharField(max_length=20, choices=PANEL_TYPES, default='line')
    ...
    fields_filter = models.JSONField(default=list, blank=True)
    time_range = models.CharField(max_length=20, default='24h')
