...
urlpatterns = [
    ...
    path(
        "services/review-import/",
        views.review_compose_import_view,
        name="review_compose_import",
    ),
    path(
        "services/clear-import/",
        views.clear_compose_import_view,
        name="clear_compose_import",
    ),
    path(
        "services/<str:service_id>/", views.service_detail_view, name="service_detail"
    ),
    path(
        "services/<str:service_id>/restart/",
        views.restart_service,
        name="restart_service",
    ),
    path("services/<str:service_id>/scale/", views.scale_service, name="scale_service"),
    path(
        "services/<str:service_id>/remove/", views.remove_service, name="remove_service"
    ),
    # Nodes
